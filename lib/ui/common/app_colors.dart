...
// final Color kPrimary = '#EFEFE9'.toColor();
final Color kPrimary = '#56595B'.toColor();
final Color kSecondary = '#B4C89A'.toColor();
final Color kPrimaryMedium = '#FFF89A'.toColor();
final Color kCoffee = '#5C4033'.toColor();
...
final Color kCoralPink = "F4806D".toColor();
